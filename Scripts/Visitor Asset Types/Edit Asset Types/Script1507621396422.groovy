...
WebUI.click(findTestObject('Visitor Asset Types/edit_asset_types'))

WebUI.setText(findTestObject('Visitor Asset Types/edit_asset_description'), 'visitor\'s car')

WebUI.click(findTestObject('Visitor Asset Types/button_Update'))
