...
WebUI.setText(findTestObject('Visitor Asset Types/asset_name'), var_asset_name)

WebUI.setText(findTestObject('Visitor Asset Types/asset_description'), var_asset_description)
