...
WebUI.setText(findTestObject('Sign Up In Request Meeting/input_email'), 'dennisgituto1@gmail.com')

WebUI.setText(findTestObject('Sign Up In Request Meeting/input_password'), 'desteg')

WebUI.setText(findTestObject('Sign Up In Request Meeting/input_password_confirmation'), 'desteg')

WebUI.click(findTestObject('Sign Up In Request Meeting/button_Sign Up'))
